...
<head>
    ...
    <meta charset="UTF-8">
    <title>Hair Specialist - SalonBooking.lk</title>
...
<body>
    ...
    <section>
       ...
       <div class = "text-container">
           <p>Hello,</p>
           <p>I'M sheshan</p>
           <p>I am a Hair Specialist</p>
           <div class="button">
            <button class="hire-btn">Hire me</button>
           </div>
       </div>
            <img src="../images/model3,jpg.jpg" class="model3" alt="model3">
    </section>
    ...
    <!--------about------------------------>
        <div class="about-text">
            <p>About Me</p>
            <p>Hair Specialist</p>
            <p>Name           : sheshan<br><br>
                Age           : 30<br>
                Qualification : BSc(spl)in UK School of Barbering<br>
                Experiance    : 7years<br>
                Tasks         : Hair Treatments, Herbel Treatments, Other Treatments<br>
                Email     :<a href="www.Gmail.com">sheshan6145@gmail.com.</a> </p>
     ...
     <div class="box-container">
        <!----1-->
            ...
            <button><a href ="about_us_index.php">View more</a></button></div>
        <!-----2-->
            <div class="box-2">
                <span>2</span>
                ...
                <button><a href ="about_us_sub02_index.php">veiw more</a></button>  
            </div>
        <!-----3--->
            <div class="box-3">
                <span>3</span>
            ...
            <button><a href ="about_us_sub01_index.php">veiw more</a></button>
            </div>
        </div>
