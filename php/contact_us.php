...
<html>
    <head>
        ...
        <title> Contact Us - SalonBooking.lk </title>
            ...
            <form class="form">
                <div class="bg1">
                    ...
                    <div class="container1">
                        <h1 id="title"><b>Get in touch!</b></h1>
                        ...
                        <input type="text" placeholder="ex: myname@example.com" required>
                        ...
                        <label class="f1"><b>Message</b></label>
                        <textarea  placeholder="Write Your Message.." style="height:200px"></textarea>
                    ...
                    <div class="hero-text">
                        ...
                        <h1 style="font-size:50px"><b>ADDRESS</b></h1>
                        ...
                        <h1 style="font-size:50px"><b>CALL US</b></h1>
                        <p style="margin-left: 20px;">
                            011 4589562<br><br>
                            011 4589562<br><br>
                            011 4589562<br><br>
                        ...
                        <h1 style="font-size:50px"><b>OPENING HOURS</b></h1>
                        <p style="margin-left: 20px;">
                            Monday - Sunday....10 am - 8pm <br><br>
