...
<?php
        ...
        if (isset($_POST['admin_login']))
        {
            ...
            if (empty($errors))
            {
                ...
                $query = "SELECT * FROM admin WHERE user_name = '{$admin_name}' AND password = '{$admin_password}' LIMIT 1";
            ...
            <form action="admin_login.php" method="post">
                ...
                <div class="container-div" style="background-color:#ffffff">
                    ...
                    <div class="container">
                        ...
                        <div class="center-button"> <button class="button-login" type="submit" name="admin_login"> Login </button> </div> 
           

                        <div class="center-button"> <a href="customer_login.php"> <button type="button" class="button-admin"> Customer Login </button> </a> </div>
