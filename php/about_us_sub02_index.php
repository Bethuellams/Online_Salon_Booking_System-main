...
<head>
    ...
    <meta charset="UTF-8">
    <title>Beauty Therapist - SalonBooking.lk</title>
...
<body>
    ...
    <section>
       ...
       <div class = "text-container">
           <p>Hello,</p>
           <p>I'M Hashini</p>
           <p>I am a Beauty Therapist</p>
           <div class="button">
                <button class="hire-btn">Hire me</button>
           </div> 
       </div>
            <img src="../images/model2.jpg" class="model2" alt="model2">
    </section>
    ...
    <!--------about------------------------>
        <div class="about-text">
            ...
            <p>Name          : Hashini Peris<br><br>
               Age           : 22<br>
               Qualification : Dip.Modeling<br>
               Experiance    : 2years<br>
               Tasks         : Herbel Treatments, Hair Treatments<br>
               E-mail        : <a href = "www.gmail.com">hashiniperis000@gmail.com </a></p>
    ...
    <div class="box-container">
        ...
        <!-----3--->
            ...
            <button><a href ="about_us_sub03_index.php">veiw more</a></button>
            </div>
        </div>
             <!----- FOOTER - START ----->
