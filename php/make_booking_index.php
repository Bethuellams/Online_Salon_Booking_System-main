...
<html>
    ...
    <body>
        ...
        <div class="section01" style="height: 800px; background-color: #f3eded;">
            ...
            <center>
                <div style="border: 1px solid black; width: 50%; position: relative; top: 100px;"> 
                    <div>
                        <p class="topic"> Please Sign In </p> <br>
                        <button class="buttons" onclick="document.location='customer_login.php'"> Sign In </button>
                        <button class="buttons" onclick="document.location='customer_signup.php'"> Sign Up </button>
                    </div>
