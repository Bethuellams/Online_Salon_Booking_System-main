...
<?php
    ...
    if (isset($_POST['add']))
    {
        ...
        if ($result_set)
        {
            ...
            {
                $item_id_exists = 'Item ID already exists';
                $error = '1';

                $item_name_enterd = $item_name;
                $item_price_enterd = $item_price;
        ...
        if (empty($error)) 
        {
            $query = "INSERT INTO product (item_id, item_category, item_name, item_price) VALUES ('{$item_id}', '{$item_category}', '{$item_name}', '{$item_price}')";
...
<html>
    <head>
        ...
        <title> Add Products - SalonBooking.lk </title>
        ...
        <div class="section01" style="height: 800px; background-color: #f3eded;">
            ...
            <div class="section01-div" style="margin: 0 auto; max-width: 500px; text-align: center; border: 1px solid black; position: relative; top: 120px; background-color: #ffffff;">
                ...
                <div class="section01-div-form" style="text-align: left; margin: 10px;">
                    ...
                    <b> <p style="font-size: 25px; text-align: center;"> Add Product </p> </b> <br>

                    <p style="font-size: 25px; text-align: center; color: red;"> <?php echo $item_id_exists ?> </p>
                    ...
                    <form action="add_products.php" method="post">
                        ...
                        <select name="item_category" id="item_category">
                            ...
                            <option value="Hair Cares"> Hair Cares </option>
                            <option value="Makeups"> Makeups </option>
                            <option value="Men's Cares"> Men's Cares </option>
                            <option value="Skin Cares"> Skin Cares </option>
                        </select><br>

                        <label for=""> Item ID : </label>
                        <input type="text" name="item_id" style="margin-left: 62px;"><br>

                        <label for=""> Item Name : </label>
                        <input type="text" name="item_name" value="<?php echo $item_name_enterd?>" style="margin-left: 30px;"><br>

                        <label for=""> Item Price : </label>
                        <input type="text" name="item_price" value="<?php echo $item_price_enterd?>" style="margin-left: 38px;"><br>
