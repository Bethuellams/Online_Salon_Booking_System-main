...
<?php
    ...
    if (isset($_POST['register']))
    {
        ...
        if (empty($error)) 
        {
            $query = "INSERT INTO customer (user_name, first_name, last_name, gender, email, mobile_no, city, password, user_type) VALUES ('{$user_name}', '{$first_name}', '{$last_name}', '{$gender}', '{$email}', '{$mobile_no}', '{$city}', '{$password}', 1)";
...
<html>
    ...
    <body>
        ...
        <div class="form_background">
            <form class="form" action="customer_signup.php" method="post">
                <div class="bg1">
                    <div class="container">
                        ...
                        <button type="button" class="button" onclick="document.location='admin_signup.php'">Admin Sign Up</button><br><br>
