...
<head>
    <meta charset="UTF-8">
    <title> Hair Dresser & Hair Specialist - SalonBooking.lk </title>
...
<body>
    ...
    <section>
       ...
       <div class = "text-container">
           <p>Hello,</p>
           <p>I'M PAUL</p>
           <p>I am Hair Dresser & Hair Specialist</p>
           <div class="button">
                <button class="hire-btn">Hire me</button>
            </div>
       </div>
            <img src="../images/model.jpg" class="model" alt="model">
    </section>
    ...
    <!--------about------------------------>
        <div class="about-text">
            <p>About Me</p>
            <p>Hair Stylist & Specialist</p>
               Name          : Paul Brayan<br><br>
               Age           : 24<br>
               Qualification : Certificate III in Barbering (SHB30516)<br>
               Experiance    : 3years<br>
               Tasks         : Hair Cut, Beard Cut, Hair Treatments<br>
               E-mail        : <a href = "www.yahoo,com">paulbrayan322@yahoo.com</a></p>
                ...
                <div class="box-container">
                    <!----1-->
                        ...
                        <button><a href ="about_us_sub01.php">View more</a></button></div>
                    <!-----2-->
                        <div class="box-2">
                            <span>2</span>
